  ...
  $('#save').click(function(){
   ...
   else
   {
    if($('#save').text() == 'Save')
    {
     ...
     output += '<td>'+jumlah_penghasilan+'<input type="hidden" id="jumlah_penghasilan'+count+'" name="hidden_jumlah_penghasilan[]"  value="'+jumlah_penghasilan+'" /></td>';
