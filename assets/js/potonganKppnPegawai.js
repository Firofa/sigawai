...
$(document).ready(function(){ 
    ...
    $('#add').click(function(){
     ...
     var error_tgl_gaji = '';
       if($('#tgl_gaji').val() == '')
       {
         ...
         $('#perkiraan_id').val('');
         $('#jumlah_potongan_kppn').val('');
         $('#error_perkiraan_id').text('');
         $('#error_jumlah_potongan_kppn').text('');
         $('#perkiraan_id').css('border-color', '');
         $('#jumlah_potongan_kppn').css('border-color', '');
         $('#save').text('Save');
    ...
    $('#save').click(function(){
     ...
     var error_jumlah_potongan_kppn = '';
     var perkiraan_id = '';
     var jumlah_potongan_kppn = '';
     if($('#perkiraan_id').val() == '')
     {
     ...
     if($('#jumlah_potongan_kppn').val() == '')
     {
      error_jumlah_potongan_kppn = 'Jumlah potongan_kppn perlu diisi';
      $('#error_jumlah_potongan_kppn').text(error_jumlah_potongan_kppn);
      $('#jumlah_potongan_kppn').css('border-color', '#cc0000');
      jumlah_potongan_kppn = '';
     }
     else
     {
      error_jumlah_potongan_kppn = '';
      $('#error_jumlah_potongan_kppn').text(error_jumlah_potongan_kppn);
      $('#jumlah_potongan_kppn').css('border-color', '');
      jumlah_potongan_kppn = $('#jumlah_potongan_kppn').val();
     }
     if(error_perkiraan_id != '' || error_jumlah_potongan_kppn != '')
     {
      return false;
     }
     else
     {
      if($('#save').text() == 'Save')
      {
       ...
       output += '<td>'+jumlah_potongan_kppn+'<input type="hidden" id="jumlah_potongan_kppn'+count+'" name="hidden_jumlah_potongan_kppn[]"  value="'+jumlah_potongan_kppn+'" /></td>';
      ...
      else 
      {
       ...
       output += '<td>'+jumlah_potongan_kppn+' <input type="hidden" name="hidden_jumlah_potongan_kppn[]" id="jumlah_potongan_kppn'+row_id+'" value="'+jumlah_potongan_kppn+'" /></td>';
    ...
    $(document).on('click', '.view_details', function(){
     ...
     var jumlah_potongan_kppn = $('#jumlah_potongan_kppn'+row_id+'').val();
     $('#perkiraan_id').val(perkiraan_id);
     $('#jumlah_potongan_kppn').val(jumlah_potongan_kppn);
     $('#save').text('Edit');
   ...
   $('#perkiraan_form').on('submit', function(event){
     ...
     if(count_data > 0)
     {
      ...
      $.ajax({
       url:"potongan/tambahPotonganKppn",
       method:"POST",
       data:form_data,
       success:function(data)
       {
        ...
        document.location.href = "potongan";
       },
