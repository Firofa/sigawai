       ...
       <div class="box">
        ...
        <div class="box-body">
          ...
          <form method="post" id="perkiraan_form" action="<?= base_url('potongan/tambahGaji'); ?>">
              ...
              <div class="col-xs-6">  
                <div class="form-group ">
                  <label for="tgl_gaji">Tanggal Pendapatan:</label>
                  <input type="date" class="form-control form-control-user" id="tgl_gaji" name="tgl_gaji" placeholder="Masukan Tanggal Pendapatan..." value="<?= set_value('tgl_gaji'); ?>">
