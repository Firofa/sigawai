    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Edit Data Potongan Internal</h3>
        ...
        <?= $this->session->flashdata('message'); ?>
            <?= form_open_multipart('Potongan/doEditPotonganInternal/'); ?>
                ...
                <div class="form-group">
                    <h4>Jenis Internal : <?= $editData['nama_perkiraan']; ?></h4>
                </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-2">
                                <label><h4>Jumlah Potongan Internal:</h4></label>
                            </div>
                            <div class="col-sm-4">
