    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Tabel Referensi Gaji</h3>
                  ...
                  <?php foreach ($dataGaji as $data): ?>
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('Gaji/hapusGaji/'.$data['id_rtg']); ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="btn btn-block btn-danger"><i class="fa fa-trash"></i> Delete</a>
                        </td>
                      </tr>
                        <?php $i++; ?>
                      <?php endforeach; ?>
