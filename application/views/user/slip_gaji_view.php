        ...
        success: function(response){
          ...
          if(len > 0){
            ...
            if(obj.transaksi_gaji_id !== null){
              output = '<a href="cetakSlipGajiPdf/'+obj.transaksi_gaji_id.id_transaksi_gaji+'" target="_blank" class="btn btn-primary pull-right" style="margin-top:17px;">Cetak PDF</a>';
