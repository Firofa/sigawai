...
class Remunerasi extends CI_Controller {
    ...
    public function index() {
            ...
            $data['jenis_remunerasi'] = $this->perkiraan->GetDataPerkiraanByStatus(4);
    ...
    public function tambahRemunerasi(){
        $perkiraan_id = $this->input->post('hidden_perkiraan_id');
        $jumlah_penghasilan = $this->input->post('hidden_jumlah_remunerasi');
    ...
    public function referensi() {
        ...
        //Mengambil data perkiraan
        $this->load->model('gaji_model','gaji');
        $data['dataRemunerasi'] = $this->gaji->GetDataTransaksiByStatus(4);
        $this->load->view('templates/admin_header',$data);
        $this->load->view('templates/admin_topbar',$data);
        $this->load->view('templates/admin_sidebar',$data);
        $this->load->view('admin/pengaturanRemunerasi/referensiRemunerasi_view',$data);
        $this->load->view('templates/admin_footer',$data);
    }

    public function editRemunerasi($id_rtg){
        $data['title'] = "Admin Page | Sigawai";
        ...
        $this->load->view('templates/admin_topbar',$data);
        $this->load->view('templates/admin_sidebar',$data);
        $this->load->view('admin/pengaturanRemunerasi/editRemunerasi_view',$data);
    }

    public function doEditRemunerasi() {
        ...
        if($result >= 1) {
                ...
                if($result >= 1) {
                    ...
                    '<div class="alert alert-dismissible alert-success">
                            ...
                            Data Remunerasi Telah Diupdate!
                    </div>');
                    ...
                    '<div class="alert alert-dismissible alert-danger">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        Data Remunerasi Gagal Diupdate
                    </div>');
